...
export default function PublicRecord(props) {
    ...
    return (
        <div>
            ...
            <Link href={{ pathname: '/TechnicalDetails'}}>
                    <Button variant="contained" color="primary">View Technical Details</Button>
            </Link>

            <p></p>

            <Link href={{ pathname: '/Programming'}}>
                    <Button variant="contained" color="primary">View Programming</Button>
            </Link>
                      </center>        
            <p></p>
           ...
           <center>
            ...
            <img width="500" height="300"src = "https://raw.githubusercontent.com/farooqashar/MediaInfrastructure/master/fmb.jpg"></img>
            <p></p>
            <img width="500" height="300"src = "https://media.npr.org/assets/img/2013/04/23/coverage_map_custom-19ec2848cfbc659fc9e3dcac92824024327efa64-s1600-c85.jpg"></img>
          ...
          <img width="500" height="250" src = "https://www.insidehighered.com/sites/default/server_files/styles/large/public/media/Schools%20page/Boston%20University_0.jpg?itok=vbogch3C"></img>
